...
extension World {
    ...
    fileprivate func objc_fit(_ description: String, flags: FilterFlags, file: String, line: UInt, closure: () -> ()) {
        fit(description, flags: flags, file: file, line: line, closure: closure)
    }

    @objc(xitWithDescription:flags:file:line:closure:)
    fileprivate func objc_xit(_ description: String, flags: FilterFlags, file: String, line: UInt, closure: () -> ()) {
